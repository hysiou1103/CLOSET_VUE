<template>
    <div class="adminProduct">
        <div class="text-right">
            <button class="btn btn-primary text-white my-3" @click="openModal('new')">建立新產品</button>
        </div>
                ...
                <tbody>
                    <tr v-for="item in products" :key="item.id">
                        ...
                        <td class="text-center d-md-block">
                            ...
                            <button class="btn btn-outline-danger btn-sm ml-1" @click="openModal('delete',item)">刪除</button>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary text-white" @click="updateProduct()">確定</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    是否確認刪除 {{tempProduct.title}}
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">取消</button>
                    <button type="button" class="btn btn-danger" @click="deleteProduct()">確定</button>
                </div>
                </div>
            </div>
        </div>
