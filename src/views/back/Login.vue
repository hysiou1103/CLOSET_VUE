<template>
    <div class="login">
        <Alert/>
        <div class="m-2">
            <router-link to="/" class="d-block text-primary text-center p-4 h3">ADMIN LOGIN</router-link>
            <form @submit.prevent="login()">
                ...
                <small>
                    <a href="https://support.google.com/accounts/answer/41078?hl=zh-Hant&co=GENIE.Platform%3DDesktop"
                    target="_blank">
                    Forgot Your Passowrd?
                    </a>
                </small>
                <button type="submit" class="btn btn-outline-secondary my-2">LOGIN</button>
                <a href="https://www.facebook.com/help"
                    target="_blank" class="fb btn mt-2">
                    Login with Facebook
                </a>
            </form>
        </div>
