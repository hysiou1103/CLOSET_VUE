    ...
    <div>
                                ...
                                <div class="row ">
                                    <div class="col-lg-10 col ">
                                            ...
                                            <p class="py-2 text-md-dark">
                                                CLOSET 始終秉持著舒適、質感及環保精神，採用有機棉及天然染色原料，陪伴妳體驗生活中的大小細節。
                                                無時無刻、無論是活潑、自信、幹練的妳，都能夠在這裡找到自己的風格。
                                            </p>
                                            <div class="text-md-left text-right">
                                                <router-link to="/products" class="btn btn-outline-warning my-1">立即前往選購</router-link>
                                            </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="productLink preFadein">
            <ul class="d-flex p-0 mb-0">
                ...
                <li>
                    <a href="#" @click.prevent="goProduct('Dress&Jumpsuit')">
        ...
        <section class="subscribeWrap preFadein container-fluid bg-light py-4">
            <div class="container subscribe">
                <div class="row">
                    ...
                    <div class="col-md-7 d-flex flex-column justify-content-center align-items-center align-items-md-end py-4 ">
                        <div class="content">
                            <h3 class="text-center py-2"><i class="far fa-bell"></i> Join Us !</h3>
                            <div class="h5">訂閱<span class="d-none d-md-inline-block">電子報</span>以取得最新商品及優惠資訊</div>
                            <ValidationProvider rules="required|email" v-slot="{classes}">
                                <div class="d-flex">
                                    <input type="email" class="form-control mr-1" name="信箱" v-model="mail"
                                        id="email" :class="classes">
                                    <button class="btn btn-dark" type="button" @click="checkedMail">
                                        SUBSCRIBE
                                    </button>
                                </div>
                            </ValidationProvider>
            ...
            <div class="ads" >
                ...
                <div class="forth">
                    <div class="closeIcon text-right">
                        <a href="#" @click.prevent="adsClose = true"><i class="fas fa-times"></i></a>
                    </div>
...
export default {
  ...
  created () {
    setTimeout(() => { this.adsShow = true }, 1000)
    setTimeout(() => { this.adsClose = true }, 6000)
  },
  mounted () {
    const options = {
      root: null,
    ...
    const targets = [document.querySelector('.banner'), document.querySelector('.concept'),
      document.querySelector('.popular'), document.querySelector('.productLink'),
