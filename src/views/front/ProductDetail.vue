      ...
      <section class="row">
        ...
        <div class="product-info col-md-6">
          <div class="text-primary d-flex justify-content-between">
            ...
            <a
              href="#"
              class="far fa-heart nav-link"
              v-if="!favItemsId.includes(product.id)"
              @click.prevent="addFav(product)"
            >
            </a>
            <a
              href="#"
              class="fas fa-heart nav-link"
              v-else
              @click.prevent="removeFav(product)"
            >
            </a>
          </div>
          ...
          <select class="product-size custom-select mb-3" v-model="size">
            <option selected disabled>請選擇尺寸</option>
            <option value="S">S</option>
            <option value="M">M</option>
            <option value="L">L</option>
          </select>
          <select class="product-quantity custom-select mb-3" v-model="qty">
              ...
              <div class="card-header bg-white p-2">
                <h2 class="mb-0">
                  <button
                    ...
                    data-target="#sizeForm"
                    aria-expanded="false"
                    aria-controls="sizeForm"
                  >
                    尺寸表
                  </button>
                </h2>
              ...
              <div class="card-header bg-white p-2">
                <h2 class="mb-0">
                  <button
                    ...
                    data-toggle="collapse"
                    data-target="#washingWay"
                    aria-expanded="false"
                    aria-controls="washingWay"
                  >
                    洗滌方式
                  </button>
                </h2>
              ...
              <div id="washingWay" class="collapse" data-parent="#helper">
                <div class="card-body">
                  <ul>
                    <li>深、淺色衣物請務必分開洗滌。</li>
                    <li>
                      所有衣物洗滌方式建議反面冷水手洗，並且請勿長時間浸泡，禁止烘乾，較能延長衣物使用壽命。
                    </li>
                    <li>
                      針織類商品勿吊掛，清洗後於通風處平放陰乾，如有打結連接處，請勿修剪，將線頭反塞回衣服內裏。
                    </li>
                    <li>
                      外套類商品建議送洗衣店清潔，平時建議放置通風處保持乾燥。
                    </li>
                  </ul>
                </div>
              </div>
