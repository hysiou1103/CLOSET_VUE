    ...
    <section class="container">
        ...
        <div class="table-responsive">
          <table class="table cartInfo">
            <thead>
              ...
              <th width="180" class="text-center d-none d-md-table-cell">
                數量
              </th>
              ...
              <tr class="d-md-none">
                <td colspan="2" class="pt-2">
                  <div class="form-check text-left">
                    ...
                    />
                    <label
                      class="normalcheck form-check-label"
                      for="principleConfirm"
                    >
                      我同意接受
                      <router-link to="/faq" class="principle"
                        >購物須知 & 隱私權政策</router-link
                      >
                      。
                    </label>
                    <label
                      class="tinycheck form-check-label"
                      for="principleConfirm"
                    >
                      我同意接受 <br />
                      <router-link class="principle" to="/faq"
                        >購物須知 & 隱私權政策</router-link
                      >
                      。
                    </label>
                ...
                <td colspan="1" class="pt-2">
                  <div class="text-right">
                    ...
                    >
                      結帳去
                      <i
                        class="fas fa-shopping-basket d-none d-sm-inline-block"
                      ></i>
                    </router-link>
                  </div>
                </td>
      ...
      <template v-else>
        <router-link to="/products" class="emptyCart nav-link h5 text-center">
          <i class="far fa-hand-point-right"></i> 更多精選商品，快來加入購物車
